...
const Hero = () => {
  return (
    <div className='relative overflow-clip py-24 bg-[linear-gradient(to_bottom,#000,#2B1942_35%,#1F7D53_60%,#1F7D53_80%)]'>
      
      <div className="relative">
        <div className=" flex flex-col items-center justify-center gap-12">
          <h2 className='font-bold text-6xl text-[#98B4CE]'>Hola, soy</h2>
          <h1 className='text-6xl font-bold md:text-8xl text-[#1F7D53]'>Yemil Rios</h1>
